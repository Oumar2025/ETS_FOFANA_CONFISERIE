...
export const translations = {
  en: {
    ...
    heroDesc: 'Welcome to the internal decision support platform for ETS FOFANA CONFISERIE. FOF-AI provides executive management with real-time inventory monitoring, demand forecasting, seasonal multiplier analysis, automated milestone email alerts, and interactive AI consultation.',
    ...
    dashSubtitle: 'Real-time inventory intelligence & demand forecasts for ETS FOFANA CONFISERIE',
  ...
  fr: {
    ...
    // Home Page
    heroTitle: 'FOF-AI — Assistant d\'Intelligence d\'Affaires par Intelligence Artificielle',
    heroDesc: 'Bienvenue sur la plateforme interne d\'aide à la décision pour ETS FOFANA CONFISERIE. FOF-AI offre à la direction générale une surveillance des stocks en temps réel, des prévisions de demande, l\'analyse des coefficients saisonniers et un assistant IA interactif.',
    ...
    dashSubtitle: 'Intelligence des stocks en temps réel & prévisions de demande pour ETS FOFANA CONFISERIE',
